...
const Template2 = forwardRef(({ data, type = 'bill' }, ref) => {
  ...
  return (
    <div ref={ref} className="bg-white text-black font-sans mx-auto" style={{ width: '215.9mm', height: '350mm', minHeight: '350mm', maxHeight: '350mm', padding: '8mm', boxSizing: 'border-box' }}>
      <style>{`
        @media print {
          @page { margin: 0; }
      ...
      {/* Main Container */}
      <div className="flex flex-col relative" style={{ height: '325mm', minHeight: '325mm', maxHeight: '325mm', pageBreakInside: 'avoid' }}>
