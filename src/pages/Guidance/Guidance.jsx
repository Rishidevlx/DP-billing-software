...
export default function Guidance() {
  ...
  const deleteTestData = () => {
    if (!window.confirm("Are you sure you want to delete ALL clients, bills, returns, and receipts data?")) return;
        ...
        {activeTab === 'overview' && (
          <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-5 border border-red-200 dark:border-red-900/50 rounded-lg bg-red-50 dark:bg-red-900/10 md:col-span-2 mt-2">
                <h3 className="font-bold text-red-800 dark:text-red-400 mb-2">Developer / Testing Tools</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">Use these tools to generate or clear dummy data for testing the application.</p>
                <div className="flex gap-4">
                  <button 
                    onClick={generateTestData}
                    className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded shadow-md text-sm cursor-pointer"
                  >
                    Generate Test Data
                  </button>
                  <button 
                    onClick={deleteTestData}
                    className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-bold rounded shadow-md text-sm cursor-pointer"
                  >
                    Delete Data
                  </button>
                </div>
